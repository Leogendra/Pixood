...
// Storage keys
export const TAG_CATEGORIES_STORAGE_KEY = 'PIXEL_TRACKER_TAG_CATEGORIES';
export const TAGS_STORAGE_KEY = 'PIXEL_TRACKER_TAGS';
export const LOGS_STORAGE_KEY = "PIXEL_TRACKER_LOGS";
export const SETTINGS_STORAGE_KEY = "PIXEL_TRACKER_SETTINGS";
